...
const DailyVoiceRecorder = () => {
  ...
  const saveEntry = () => {
    ...
    const title = entryTitle.trim() || `Record Entry ${new Date().toLocaleDateString()}`;
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-100">
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
          ...
          {/* Empty State */}
          {entries.length === 0 && !finalTranscript && !interimTranscript && !isRecording && (
